...
void compileProgram(void){
  ...
  // create program object and enter its scope
...
void compileBlock(void){
  ...
  if (lookAhead->tokenType == KW_CONST) {
    ...
    do {
      ...
      // create constant object, check duplicate, then parse and attach value
...
void compileFuncDecl(void){
  ...
  // create and declare function object in current scope first (for recursion)
  Object* func = createFunctionObject(currentToken->string);
  declareObject(func);

  // enter function scope to declare parameters and locals
  enterBlock(func->funcAttrs->scope);

  compileParams();
  eat(SB_COLON);
  func->funcAttrs->returnType = compileType();
...
void compileParam(void){
  ...
  case TK_IDENT: {
    ...
    Object* param = createParameterObject(currentToken->string, PARAM_VALUE, owner);
  ...
  case KW_VAR: {
    ...
    Object* param = createParameterObject(currentToken->string, PARAM_REFERENCE, owner);
